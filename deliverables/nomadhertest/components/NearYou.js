...
export default class App extends React.Component {
  constructor(props){
    ...
    this.state = {
      ...
      listitems: []
        ...
        // {key: "Gabi Barnett", url:"https://cdn1.iconfinder.com/data/icons/user-pictures/100/female1-512.png"},
        // {key: "Eleonora Cosmelli", url:"https://cdn1.iconfinder.com/data/icons/user-pictures/100/girl-512.png"},
        // {key: "Zuzana Slabakova", url:"https://cdn1.iconfinder.com/data/icons/user-avatars-2/300/16-512.png"},
        // {key: "Hyo Jeong Kim", url:"https://cdn1.iconfinder.com/data/icons/user-avatars-2/300/09-512.png"},
        // {key: "Susan Lee", url:"https://cdn1.iconfinder.com/data/icons/user-avatars-2/300/11-512.png"},
        // {key: "Lily King", url:"https://cdn1.iconfinder.com/data/icons/user-avatars-2/300/06-512.png"},
  ...
  Ref.on("value", snapshot=>{
       snapshot.forEach((child)=>{
         items.push({key:child.child("name").val(), url:child.child("image").val(), id:child.key});
       });
      ...
      <List containerStyle={{ borderTopWidth: 0, borderBottomWidth: 0, marginTop: 0, marginBottom:0 }}>
        <FlatList
          ...
          renderItem={({item}) => (
            <View>
            <ListItem
              onPress={() => navigate('profile', {real_userid: item.id})}
              roundAvatar
              avatar={{uri: item.url}}
              title={item.key}
              subtitle={<Text>   Status: Paris on road trip</Text>}
              rightIcon={<Icon
                          color='green'
                          name='chat'
                          /*The id seemed to be able to send to the next navigation page, I'm not sure if the problem occured here*/
                          onPress={() => navigate('chat', {real_userid: item.id})}/>}
